...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Натальная карта — это snapshot неба в момент вашего рождения. Она показывает расположение планет в знаках и домах, аспекты между ними и ключевые темы вашей жизни.',
    icon: Target,
    target: null,
    education: true,
  },
  ...
  },
  {
    id: 'actions',
    title: 'Типы карт',
    description: 'Из натальной карты можно построить синастрию (совместимость), транзиты (текущие влияния), соляр/лунар (прогнозы) и профекцию. Premium открывает все типы.',
    icon: Heart,
  ...
  },
  {
    ...
    description: 'В профиле вы можете управлять подпиской, добавить данные партнёров для синастрии и выйти из аккаунта.',
    icon: BookOpen,
