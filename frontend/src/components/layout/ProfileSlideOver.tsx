...
const PREMIUM_FEATURES = [
  ...
  { text: 'Синастрия, композит и Давидсон' },
  { text: 'Транзиты на любую дату + таймлайн' },
  { text: 'Соляр, лунар и планетарные возвраты' },
  { text: 'Профекции (управитель года)' },
  { text: 'Солярные дирекции и прогрессии' },
  { text: 'Хорар и электив' },
  { text: 'Ректификация времени рождения' },
  { text: 'Звёздный двойник' },
  { text: 'Плэннер и PDF-отчёты' },
]
