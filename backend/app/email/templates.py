...
<tr><td style="background:linear-gradient(135deg,rgba(28,18,6,0.95),rgba(10,6,18,0.98));border:1px solid rgba(212,175,55,0.2);border-radius:16px;padding:40px 32px;">
<h2 style="margin:0 0 16px;color:#F0EAD6;font-size:22px;font-weight:600;">Сброс пароля</h2>
<p style="margin:0 0 24px;color:#8B7FA8;font-size:15px;line-height:1.6;">Вы запросили сброс пароля для вашего аккаунта Orbitron. Нажмите кнопку ниже, чтобы задать новый пароль:</p>
<table width="100%" cellpadding="0" cellspacing="0">
<tr><td align="center">
<a href="{reset_url}" style="display:inline-block;background:linear-gradient(135deg,#D4AF37,#B8960F);color:#0A0612;font-size:16px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px;">Сбросить пароль</a>
</td></tr>
</table>
<p style="margin:24px 0 0;color:#4A3F6A;font-size:13px;line-height:1.5;">Ссылка действительна 1 час. Если вы не запрашивали сброс пароля, просто проигнорируйте это письмо.</p>
</td></tr>
<tr><td align="center" style="padding-top:24px;">
<p style="margin:0;color:#4A3F6A;font-size:12px;">Orbitron · 2026</p>
</td></tr>
